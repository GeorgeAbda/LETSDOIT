...
import numpy as np
import torch
from agora.DAG.algorithm.gnnDeepRL.brain import CloudResourceGNN, train_gnn_ac,Actor,Actorv1,Critic,CloudResourceGNNv1,ActorCritic,ActorCritic_noembed
...
class Agent(object):
    def __init__(self, gamma, epsilon, reward_to_go, nn_baseline, normalize_advantages, experience_buffer,entropy_coefficient=0.01,lr=0.001,batch_size=1000,model_save_path=None
        ...
        self.actor_critic=ActorCritic_noembed(self.gnn, hidden_dim)
    ...
    def update(self,values,rewards,Qvalue,logprobs,entropy_term):
        ...
        log_probs = torch.stack(logprobs)
