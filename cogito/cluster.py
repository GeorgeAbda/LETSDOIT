from cogito.machine import Machine
...
class Cluster(object):
    ...
    @property
    def get_times(self):
        return self.times[-2] if len(self.times)>1 else 0
    @property
    def get_decisions(self):
        return self.decisions if self.decisions else None
    @property
    def numberofallocation(self):
